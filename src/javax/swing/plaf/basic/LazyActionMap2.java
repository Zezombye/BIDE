 ...
 * @author Scott Violet
 */
class LazyActionMap2 extends ActionMapUIResource {
    /**
     ...
     */
    static void installLazyActionMap(JComponent c, Class<FixedTabbedPaneUI> loaderClass,
                                     String defaultsKey) {
        ActionMap map = (ActionMap)UIManager.get(defaultsKey);
        if (map == null) {
            map = new LazyActionMap2(loaderClass);
    ...
    private LazyActionMap2(Class loader) {
        _loader = loader;
    }
        ...
        if (_loader != null) {
            ...
            try {
                Method method = klass.getDeclaredMethod("loadActionMap",
                                      new Class[] { LazyActionMap2.class });
