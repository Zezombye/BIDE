...
import com.sun.java.swing.plaf.windows.XPStyle2.Skin;
 ...
 */
class AnimationController2 implements ActionListener, PropertyChangeListener {
    ...
    private static synchronized AnimationController2 getAnimationController() {
        AppContext appContext = AppContext.getAppContext();
        Object obj = appContext.get(ANIMATION_CONTROLLER_KEY);
        if (obj == null) {
            obj = new AnimationController2();
            appContext.put(ANIMATION_CONTROLLER_KEY, obj);
        }
        return (AnimationController2) obj;
    }

    private AnimationController2() {
    ...
    private static void triggerAnimation(JComponent c,
        ...
        AnimationController2 controller =
            AnimationController2.getAnimationController();
    ...
    static void paintSkin(JComponent component, Skin skin,
        ...
        AnimationController2 controller = getAnimationController();
    ...
    private synchronized void dispose() {
        ...
        synchronized (AnimationController2.class) {
