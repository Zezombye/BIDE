...
import static com.sun.java.swing.plaf.windows.XPStyle2.Skin;
 ...
 */
public class WindowsTabbedPaneUI2 extends FixedTabbedPaneUI {
    /**
    ...
    public static ComponentUI createUI(JComponent c) {
        return new WindowsTabbedPaneUI2();
    }

    protected void setRolloverTab(int index) {
        // Rollover is only supported on XP
        if (XPStyle2.getXP() != null) {
